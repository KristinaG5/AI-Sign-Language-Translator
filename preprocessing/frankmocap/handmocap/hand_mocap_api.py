...
class HandMocap:
    def __init__(self, weights_folder):
        regressor_checkpoint = os.path.join(weights_folder, "hand_module/pretrained_weights/pose_shape_best.pth")
        ...
        self.opt.smplx_model_file = smplModelPath
        self.opt.model_root = weights_folder
