...
class H3DWModel(object):
    ...
    def __init__(self, opt):
        ...
        assert self.total_params_dim == self.cam_params_dim + self.pose_params_dim + self.shape_params_dim
        ...
        self.input_img = self.Tensor(nb, opt.input_nc, self.inputSize, self.inputSize)
        ...
        self.mean_param_file = osp.join(opt.model_root, opt.mean_param_file)
        self.load_params()
