...
if __name__ == "__main__":
    ...
    parser.add_argument("-j", "--json", help="", type=str, required=True)
    parser.add_argument("-r", "--rectangle", help="", type=bool, required=False, default=False)
    parser.add_argument("-rj", "--ratio_json", help="", type=str, required=False)
    ...
    # opens coordinates file
    # with open(args.ratio_json) as ratio_json_file:
    #     ratio_data = json.load(ratio_json_file)
